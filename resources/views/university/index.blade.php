...
<div class="container">
    <div class="row p-4 mt-2">
        <div class="col-md-12">
            <div class="d-flex">
                <div><h2>Creating University</h2></div>
                <div class="ml-auto">
                ...
                <form action="{{url('/university')}}" method="post">
                    @csrf
                        <div class="form-group row mt-3">
                            <label for="name" class="col-md-3 col-form-label text-md-right">{{ __('Create New University') }}</label>
            ...
            <table class="table table-striped table-sm">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ URL::to('university/' . $item->id . '/edit') }}" class="pr-1" title="edit">
                            ...
                            <form action="{{ URL::to('university/' . $item->id ) }}" method="post"
