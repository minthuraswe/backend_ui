    ...
    <div class="row pt-0 px-4 pb-4">
        <div class="col-md-12">
            <form action="/search-category" method="get" class="form-inline" >
                <input class="mr-sm-2  mb-1" type="search" placeholder="Search..." aria-label="Search" name="search">
            ...
            <div class="mt-2">
                ...
                <a href="/category" class="float-right text-info">Back to category</a>
            </div>
            ...
            @endif
            @elseif(session('search_category'))
            <div class="mt-2">
                <p>{{session('search_category')}}<a href="/category" class="text-info pl-2"> Back to category</a></p>
            </div>
            @endif
        </div>
    </div>
