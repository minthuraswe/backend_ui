            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <form action="{{url('member/' . $mem->id )}}" method="post">
                        ...
                        <div class="col-md-6">
                            <input  type="text" class="form-control" name="mem_name" placeholder="Member Name" value="{{$mem->mem_name}}" required>
                        </div>
                        </div>
                        <div class="form-group row mt-3">
                            <label for="email" class="col-md-3 col-form-label text-md-right">{{ __('Email') }}</label>
                        <div class="col-md-6">
                            <input  type="email" class="form-control" name="mem_email" placeholder="Member Email" value="{{$mem->mem_email}}" required>
                        </div>
                        </div>
                        <div class="form-group row mt-3">
                        ...
                        <div class="col-md-6">
                            <input type="date" class="form-control" name="mem_age"
                             value="{{$mem->mem_age}}" required>
                        </div>
                        </div>
                        <div class="form-group row mt-3">
                            <label for="phone" class="col-md-3 col-form-label text-md-right">{{ __('Phone') }}</label>
                        <div class="col-md-6">
                            <input  type="text" class="form-control" name="mem_phone" placeholder="Member Phone" value="{{$mem->mem_phone}}" required>
                        </div>
                        </div>
                        <div class="form-group row mt-3">
                        ...
                        <div class="col-md-6">
                            <textarea rows="3" class="form-control" name="mem_address" placeholder="Member Address" required>{{$mem->mem_address}}
                            </textarea>
                        </div>
                        </div>
                        <div class="form-group row mt-3">
                        ...
                        <div class="col-md-6">
                            <textarea rows="6" class="form-control" name="mem_description" placeholder="Member Description" required>{{$mem->mem_description}}
