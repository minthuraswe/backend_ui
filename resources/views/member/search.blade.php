            ...
            <div class="d-flex">
                ...
                <form class="form-inline">
                    <input class="mr-sm-2 ml-sm-2 mb-1" type="search" placeholder="Search" aria-label="Search"
                        name="search">
                    <a href="/search-member"><button class="mb-1" type="submit">Search</button></a>
                </form>
            </div>
            ...
            @if(isset($searchdata))
                @if($search_count == true)
                    <div>
                        ...
                        <a href="/member" class="float-right text-info">Back to member</a>
                    </div>
                    <table class="table-sm table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ URL::to('member/' . $item->id . '/edit') }}" title="edit" class="pr-1">
                                    ...
                                    <a href="{{ URL::to('member/' . $item->id ) }}" title="show" class="pr-1">
                                        <button class="rounded" style="border:1px solid;">
                ...
                @endif
            @elseif(session('search_member'))
            <div>
                <p>{{session('search_member')}} <a href="/member" class="text-info pl-2"> Back to member</a></p>
            </div>
