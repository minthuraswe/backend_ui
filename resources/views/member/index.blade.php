    ...
    <div class="row p-4 mt-2">
        <div class="col-md-12">
            <div class="d-flex">
                ...
                <form action="/search-member" method="get" class="form-inline" accept-charset="UTF-8">
                ...
                <div class="ml-auto">
                    <a href="{{url('/member/create')}}" class="btn btn-primary mb-3  p-2">
                    <img src="{{asset('css/images/plus.png')}}" class="mb-1 mr-1">Add New Member</a>
